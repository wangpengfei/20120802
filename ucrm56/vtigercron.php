...
if($service == 'ReAssignDueDate') {
	include_once('cron/modules/Leads/ReAssignDueDate.service');
}
...
if($service == 'SMSNotifier'){
	include_once('cron/modules/SMSNotifier/SMSNotifier.service');
}

if($service == 'Last15DaysContact'){
	include_once('cron/modules/Leads/Last15DaysContact.service');
}
if($service == 'DARTCron'){
	include_once('cron/modules/DART/DARTCron.service');
}
