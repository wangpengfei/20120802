...
function isPermitted($module,$actionname,$record_id='')
{
	...
	$tabid = getTabid($module);  //modified by wangyefeng for add create privilage
	  if($actionname=="CreateView")
	 	$actionname="Save";
	...
	{
		$permission = "no";
	//	$log->fatal("852Exiting isPermitted method ...");
	...
	elseif($others_permission_id == 8){      //add  tanbin 2010.01.13
...
function getEntityDisplayLink($entityType,$entityid)
{
	...
	if($entityType == 'groups')
	{
		...
		$display_out = "<a href='index.php?module=Settings&action=GroupDetailView&returnaction=OrgSharingDetailView&groupId=".$entityid."'>".$mod_strings['LBL_GROUPS']."::". $groupNameArr[0]." </a>";			
	}
	elseif($entityType == 'roles')
	{
		$roleName=getRoleName($entityid);	
		$display_out = "<a href='index.php?module=Settings&action=RoleDetailView&returnaction=OrgSharingDetailView&roleid=".$entityid."'>".$mod_strings['LBL_ROLES']."::".$roleName. "</a>";			
	}
	elseif($entityType == 'rs')
	{
		$roleName=getRoleName($entityid);	
		$display_out = "<a href='index.php?module=Settings&action=RoleDetailView&returnaction=OrgSharingDetailView&roleid=".$entityid."'>".$mod_strings['LBL_ROLES_SUBORDINATES']."::".$roleName. "</a>";			
	}
