 ...
 *	@param string 	$history_fldval	- history field value ie., quotestage for Quotes and status for PO, SO 
    @$modifier string  opereator 's   user_name  
 and Invoice
 */
function addInventoryHistory($module, $id, $relatedname, $total, $history_fldval,$modifier)
{
	global $log, $adb;
	...
	$qparams = array($histid,$id,$relatedname,$total,$history_fldval,$modifiedtime,$modifier);
