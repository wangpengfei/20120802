...
var addOddMinutes;
plusMinus=false;
 var mon=new Array(alert_arr['JANUARY'],alert_arr['FEBRUARY'],alert_arr['MARCH'],alert_arr['APRIL'],alert_arr['MAY'],alert_arr['JUNE'],alert_arr['JULY'],alert_arr['AUGUST'],alert_arr['SEPTEMBER'],alert_arr['OCTOBER'],alert_arr['NOVEMBER'],alert_arr['DECEMBER']);
...
function ClockAndAssign(){
	...
	if(language=="zh_cn")
	todaysDate=year+alert_arr['YEAR']+mon[month-1]+alert_arr['MON']+day+alert_arr['DAY'];
	else
	todaysDate=mon[month-1]+alert_arr['MON']+day+alert_arr['DAY']+year+alert_arr['YEAR'];
	...
	//document.getElementById("theDate").firstChild.data=todaysDate+" "+hr+":"+mins+" "+ampm;
	 if(language=="zh_cn")
	document.getElementById("theDate").firstChild.data=todaysDate+" "+ampm+" "+hr+":"+mins;
	else
	document.getElementById("theDate").firstChild.data=todaysDate+" "+hr+":"+mins+" "+ampm;
