...
class Vtiger_InventoryPDFController {
	...
	function buildSummaryModel() {
		...
		$summaryModel->set(getTranslatedString("Grand Total : ( $currencySymbol)", $this->moduleName), $this->formatPrice($final_details['grandTotal'])); // TODO add currency string
	...
	function buildHeaderModelTitle() {
		//return $this->moduleName;
			return getTranslatedString(rtrim($this->moduleName, 's'), $this->moduleName);
	}
