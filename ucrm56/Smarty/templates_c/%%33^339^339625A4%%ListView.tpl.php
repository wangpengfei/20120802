<?php /* Smarty version 2.6.18, created on 2012-06-04 08:37:29
         compiled from ListView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'ListView.tpl', 209, false),array('function', 'html_options', 'ListView.tpl', 243, false),)), $this); ?>
...
<form action="index.php" method="post" onsubmit="return check_pdf_tmp();">
<input name="module" style="margin: 0px;" type="hidden" value="PDFMaker"/>
<input name="relmodule" style="margin: 0px;" type="hidden" value="<?php echo $this->_tpl_vars['MODULE']; ?>
"/>
<input name="action" style="margin: 0px;" type="hidden" value="CreatePDF"/>
<input name="idstring" id="idstring" style="margin: 0px;" type="hidden" />
<div id="pdf_tmp_show" class="layerPopup" style="display:none;width:300px;">
<DIV style="WIDTH: 300px">
<TABLE class=layerHeadingULine border=0 cellSpacing=0 cellPadding=5 width="100%">
<TBODY>
<TR>
<TD class=genHeaderSmall width="90%" align=left><?php echo $this->_tpl_vars['APP']['SELECT_PDF_TEMPLATE']; ?>
</TD>
<TD width="10%" align=right><IMG onClick="fninvsh('pdf_tmp_show');" border=0 src="themes//images/close.gif"> </TD></TR></TBODY></TABLE>
<TABLE border=0 cellSpacing=0 cellPadding=5 width="95%" align=center>
<TBODY>
<TR>
<TD>
<TABLE border=0 cellSpacing=0 cellPadding=5 width="100%" bgColor=white align=center>
<TBODY>
<TR>
<TD >
<input type="checkbox" name="if_merge"  /><?php echo $this->_tpl_vars['APP']['IF_MERGE_MSG']; ?>

<br /><br />
<?php echo $this->_tpl_vars['APP']['SELECT_PDF_TEMPLATE']; ?>
<br /><br />
<div id="pdf_tmp_show_select" align=center >
</div>

</TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
<TABLE class=layerPopupTransport border=0 cellSpacing=0 cellPadding=5 width="100%">
<TBODY>
<TR>
<TD class=small align=middle>
<INPUT class="small crmbutton create" value=<?php echo $this->_tpl_vars['APP']['CREATE_PDF']; ?>
 type=submit> 
<INPUT class="small crmbutton cancel" onclick=fninvsh('pdf_tmp_show'); value=<?php echo $this->_tpl_vars['APP']['LBL_BLOCK_CANCEL']; ?>
 type=button>
</TD></TR></TBODY></TABLE>
</DIV>
</div>
...
var tabberOptions ={
 'onClick': function(argsObj) {
    ...
    var i = argsObj.index; /* Which tab was clicked (0 is the first tab) */
     showDefaultCustomViewTab(t.tabs[i].div.id,'<?php echo $this->_tpl_vars['MODULE']; ?>
','<?php echo $this->_tpl_vars['CATEGORY']; ?>
');
   
     /*  alert(t.tabs[i].div.id);  alert('Swtich to '+t.tabs[i].div.id+'?\nEvent type: '+e.type);*/
     
  }
};
 
</script>
<script language="JavaScript" type="text/javascript" src="tabber/tabber.js"></script>
