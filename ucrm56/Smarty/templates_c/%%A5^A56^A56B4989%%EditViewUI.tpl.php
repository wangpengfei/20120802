<?php /* Smarty version 2.6.18, created on 2012-06-04 12:28:11
         compiled from EditViewUI.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'EditViewUI.tpl', 34, false),array('modifier', 'getTranslatedString', 'EditViewUI.tpl', 61, false),array('modifier', 'getTranslatedCurrencyString', 'EditViewUI.tpl', 415, false),array('modifier', 'substr', 'EditViewUI.tpl', 472, false),)), $this); ?>
...
" LANGUAGE=javascript onclick='return window.open("index.php?module=PurchaseOrder&action=Popup&html=Popup_picker&popuptype=specific&form=EditView","test","width=700,height=602,resizable=1,scrollbars=1");' align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;<img<?php echo $this->_tpl_vars['disable']; ?>
  tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" src="<?php echo vtiger_imageurl('clear_field.gif', $this->_tpl_vars['THEME']); ?>
" alt="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_LABEL']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_LABEL']; ?>
" LANGUAGE=javascript onClick="document.EditView.purchaseorder.value=''; document.EditView.purchaseorder_name.value='';return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>
			</td>
...
?>
				...
				<?php endforeach; endif; unset($_from); ?>
				<?php if ($this->_tpl_vars['fldname'] == 'assigndue_date'): ?>
				   <SELECT id=stdDateFilter class="select small" onchange="showDateRange1(this.options[this.selectedIndex].value ,'<?php echo $this->_tpl_vars['fldname']; ?>
')" name=stdDateFilter>
...
" type="button" class="crmbutton small delete" onclick='this.parentNode.parentNode.removeChild(this.parentNode);delRowEmt("<?php echo $this->_tpl_vars['image_details']['orgname']; ?>
")'>
							</div>
...
)"><?php echo $this->_tpl_vars['APP']['LBL_DELETE']; ?>
</a></div>
					<?php endif; ?>
				<?php endif; ?>
			</td>
