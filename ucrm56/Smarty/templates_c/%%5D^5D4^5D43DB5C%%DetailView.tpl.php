<?php /* Smarty version 2.6.18, created on 2012-06-04 09:57:29
         compiled from DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'getTranslatedString', 'DetailView.tpl', 28, false),array('modifier', 'vtiger_imageurl', 'DetailView.tpl', 229, false),array('modifier', 'count', 'DetailView.tpl', 255, false),array('modifier', 'replace', 'DetailView.tpl', 358, false),array('modifier', 'urlencode', 'DetailView.tpl', 408, false),)), $this); ?>
...
<script>
var empty_amount_mandatory = "<?php echo ((is_array($_tmp='LBL_POTENTIAL_AMOUNT')) ? $this->_run_mod_handler('getTranslatedString', true, $_tmp, 'Leads') : getTranslatedString($_tmp, 'Leads')); ?>
";
<?php echo '
var gVTModule = \'{$smarty.request.module|@vtlib_purify}\';
function verify_data1(form) {
	...
	if(! form.createpotential.checked == true){
		...
		if(form.closingdate_mandatory != null && form.closingdate_mandatory.value == \'*\'){
			if (form.closedate.value == ""){
	        	alert(alert_arr.ENDDATE+alert_arr.CANNOT_BE_EMPTY);
				return false;	
			}
		}
		if (form.closedate.value != "" ){
			var x = dateValidate(\'closedate\',alert_arr.ENDDATE,\'DATE\');
			if(!x){
				return false;
			}
		}
		...
		if(form.amount_mandatory.value == \'*\'){
			if (form.potential_amount.value == ""){
	            alert(empty_amount_mandatory+alert_arr.AMOUNT_CANNOT_BE_EMPTY);
				return false;					
			}
		}	
...
function showHideStatus(sId,anchorImgId,sImagePath)
{
	...
	if(oObj.style.display == \'block\')
	{
		...
		eval(document.getElementById(anchorImgId)).alt = alert_arr.Display;
		eval(document.getElementById(anchorImgId)).title = alert_arr.Display;
	}
	else
	{
		oObj.style.display = \'block\';
		eval(document.getElementById(anchorImgId)).src = \'themes/images/activate.gif\';
		eval(document.getElementById(anchorImgId)).alt = alert_arr.Hide;
		eval(document.getElementById(anchorImgId)).title = alert_arr.Hide;
	}
}
...
"></td>
 ...
 <?php echo $this->_tpl_vars['APP']['LBL_INFORMATION']; ?>
                ...
                <input type="button" class="crmbutton small edit" value="<?php echo $this->_tpl_vars['APP']['LBL_RETURN_LIST']; ?>
" onclick="location.href='index.php?action=ListView&module=<?php echo $this->_tpl_vars['MODULE']; ?>
...
&nbsp;">&nbsp;
						<?php endif; ?>
						<?php if ($this->_tpl_vars['CREATE_DUPLICATE'] == 'permitted' && $this->_tpl_vars['MODULE'] != 'Documents'): ?>
...
'; submitFormForAction('DetailView','CreateView');" type="button" name="Duplicate" value="<?php echo $this->_tpl_vars['APP']['LBL_DUPLICATE_BUTTON_LABEL']; ?>
">&nbsp;
						<?php endif; ?>
...
></input> (<?php echo $this->_tpl_vars['keycursymb']; ?>
                ...
                <?php elseif (( $this->_tpl_vars['MODULE'] == 'Accounts' && $this->_tpl_vars['keyfldname'] == 'accountname' ) || ( $this->_tpl_vars['MODULE'] == 'Leads' && $this->_tpl_vars['keyfldname'] == 'company' )): ?>
					<td class="dvtCellLabel" align=right width=25%>
                    <input class="crmbutton small cancel" type="button" onclick="fnvshobj(this,'baidu');" value="<?php echo $this->_tpl_vars['APP']['LBL_ONLINE_SEARCH']; ?>
" />
                    <?php echo $this->_tpl_vars['label']; ?>
</td>
                    
<div id="baidu" style="display:none; background-color:#FFF" onmouseover="fnvshNrm('baidu')" onmouseout="fninvsh('baidu')">
<a href="http://www.baidu.com/s?wd=<?php echo urlencode($this->_tpl_vars['keyval']); ?>
&ie=utf-8" target="_blank"><?php echo $this->_tpl_vars['APP']['Baidu']; ?>
</a><br />
<a href="http://www.google.com.hk/search?hl=zh-CN&q=<?php echo urlencode($this->_tpl_vars['keyval']); ?>
&ie=utf-8" target="_blank"><?php echo $this->_tpl_vars['APP']['Google']; ?>
</a>
</div>
				<?php else: ?>
                <?php if ($this->_tpl_vars['MODULE'] == 'HelpDesk' && $this->_tpl_vars['keyfldname'] == 'comments'): ?><tr>
							   			<td colspan=4 class="dvtCellInfo"><?php echo $this->_tpl_vars['COMMENT_BLOCK']; ?>
</td>
							   </tr>
                <?php endif; ?>
                <?php if ($this->_tpl_vars['MODULE'] == 'Leads' && $this->_tpl_vars['keyfldname'] == 'track'): ?><tr>
							   			<td colspan=4 class="dvtCellInfo"><?php echo $this->_tpl_vars['COMMENT_BLOCK']; ?>
</td>
							   </tr>
                <?php endif; ?>
					<td class="dvtCellLabel" <?php if (( $this->_tpl_vars['MODULE'] == 'HelpDesk' && $this->_tpl_vars['keyfldname'] == 'comments' ) || ( $this->_tpl_vars['MODULE'] == 'Leads' && $this->_tpl_vars['keyfldname'] == 'track' )): ?>height="26px"<?php endif; ?> align=right width=25%><input type="hidden" id="hdtxt_IsAdmin" value=<?php echo $this->_tpl_vars['keyadmin']; ?>
></input><?php echo $this->_tpl_vars['label']; ?>
</td>
				<?php endif; ?>
				<?php if (( $this->_tpl_vars['EDIT_PERMISSION'] == 'yes' || ( $this->_tpl_vars['PERMIT_TRACK'] == 1 && $this->_tpl_vars['keyfldname'] == 'track' && $this->_tpl_vars['MODULE'] == 'Leads' ) ) && $this->_tpl_vars['display_type'] != '2'): ?>
...
" class="drop_down"><?php echo $this->_tpl_vars['customlink_label']; ?>
			...
			<?php endif; ?>
                ...
                <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/PDFMaker/InventoryPdfActions.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
...
tagCloudName_<?php echo $_SESSION['authenticated_user_language'] ?>.gif" border=0></td>
		</tr>
		<tr>
...
" class="crmbutton small create" onclick="DetailView.return_module.value='<?php echo $this->_tpl_vars['MODULE']; ?>
'; DetailView.return_action.value='DetailView'; DetailView.isDuplicate.value='true';DetailView.module.value='<?php echo $this->_tpl_vars['MODULE']; ?>
'; submitFormForAction('DetailView','CreateView');" type="submit" name="Duplicate" value="<?php echo $this->_tpl_vars['APP']['LBL_DUPLICATE_BUTTON_LABEL']; ?>
">&nbsp;
						<?php endif; ?>
						<?php if ($this->_tpl_vars['DELETE'] == 'permitted'): ?>
								<input title="<?php echo $this->_tpl_vars['APP']['LBL_DELETE_BUTTON_TITLE']; ?>
