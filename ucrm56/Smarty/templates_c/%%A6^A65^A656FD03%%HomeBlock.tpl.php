<?php /* Smarty version 2.6.18, created on 2012-06-03 22:56:22
...
" <?php if ($this->_tpl_vars['HOME_STUFF']['Maxentries'] == $this->_sections['iter']['index']): ?> selected <?php endif; ?>>
	...
	<?php endfor; endif; ?>
		...
		<td align="right" class="homePageMatrixHdr" nowrap style="height:28px;" width=60%>
			<input type="button" name="save" value="<?php echo $this->_tpl_vars['MOD']['LBL_BLOCK_SAVE']; ?>
" class="crmbutton small save" onclick="saveEntries('maxentries_<?php echo $this->_tpl_vars['HOME_STUFFID']; ?>
')">
			<input type="button" name="cancel" value="<?php echo $this->_tpl_vars['MOD']['LBL_BLOCK_CANCEL']; ?>
