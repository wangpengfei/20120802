<?php /* Smarty version 2.6.18, created on 2012-06-04 09:57:30
         compiled from DetailViewUI.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'DetailViewUI.tpl', 41, false),array('modifier', 'vtiger_imageurl', 'DetailViewUI.tpl', 53, false),array('modifier', 'getTranslatedCurrencyString', 'DetailViewUI.tpl', 64, false),array('modifier', 'strpos', 'DetailViewUI.tpl', 85, false),array('modifier', 'cat', 'DetailViewUI.tpl', 137, false),array('modifier', 'replace', 'DetailViewUI.tpl', 142, false),array('modifier', 'wordwrap', 'DetailViewUI.tpl', 144, false),array('modifier', 'regex_replace', 'DetailViewUI.tpl', 204, false),array('modifier', 'parse_calendardate', 'DetailViewUI.tpl', 372, false),)), $this); ?>
...
" target="_blank" ><?php echo $this->_tpl_vars['keyval']; ?>
				...
				<?php endif; ?>
                	...
                	<?php if ($this->_tpl_vars['keyfldname'] == 'yahooid' || $this->_tpl_vars['keyfldname'] == 'yahoo_id'): ?>
                        <?php $this->assign('qq', ((is_array($_tmp=$this->_tpl_vars['keyval'])) ? $this->_run_mod_handler('strpos', true, $_tmp, "@qq.com") : strpos($_tmp, "@qq.com"))); ?>
                        <?php if ($this->_tpl_vars['qq'] != ''): ?>
                        <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $this->_tpl_vars['keyval']; ?>
&site=qq&menu=yes">
                        <img border="0" src="http://wpa.qq.com/pa?p=2:<?php echo $this->_tpl_vars['keyval']; ?>
:17" align="absmiddle"></a>
                        <?php elseif ($this->_tpl_vars['keyval'] != ''): ?>
                        <a href="msnim:chat?contact=<?php echo $this->_tpl_vars['keyval']; ?>
"><img src="http://messenger.services.live.com/users/<?php echo $this->_tpl_vars['keyval']; ?>
/presenceimage/" align="absmiddle" border="0"></a>
                        <?php endif; ?>
                    <?php endif; ?>
...
')" class="link"><?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
						...
						<?php endif; ?>
							...
							<?php if ($this->_tpl_vars['MODULE'] == 'Documents' || $this->_tpl_vars['MODULE'] == 'News'): ?>
...
">
						...
						<div id="editarea_<?php echo $this->_tpl_vars['label']; ?>
" style="display:none;">
                                                <?php if ($this->_tpl_vars['keyfldname'] == 'assigndue_date'): ?>
						 <SELECT id=stdDateFilter class="select small" onchange="showDateRange1(this.options[this.selectedIndex].value ,'<?php echo $this->_tpl_vars['label']; ?>
')" name=stdDateFilter>
							   <OPTION value=''>自定义</OPTION>
							   <OPTION value=today>今天</OPTION>
							   <OPTION value=1>1个月后</OPTION>
							   <OPTION value=2>2个月后</OPTION>
							   <OPTION value=3>3个月后</OPTION>
							   <OPTION value=4>4个月后</OPTION>
							   <OPTION value=5>5个月后</OPTION>
							   <OPTION value=6>6个月后</OPTION>
							   <OPTION value=7>7个月后</OPTION>
							   <OPTION value=8>8个月后</OPTION>
							   <OPTION value=9>9个月后</OPTION>
							   <OPTION value=10>10个月后</OPTION>
							   <OPTION value=11>11个月后</OPTION>
							   <OPTION value=12>12个月后</OPTION>
							   </SELECT>
							   <?php echo $this->_tpl_vars['WQW_DATE']; ?>
...
">********</span>
                ...
                <div id="editarea_<?php echo $this->_tpl_vars['label']; ?>
" style="display:none;">
                	<input class="detailedViewTextBox" onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'" type="password" id="txtbox_<?php echo $this->_tpl_vars['label']; ?>
" name="<?php echo $this->_tpl_vars['keyfldname']; ?>
" maxlength='100' value="<?php echo $this->_tpl_vars['keyval']; ?>
"></input>
                    <br><input name="button_<?php echo $this->_tpl_vars['label']; ?>
