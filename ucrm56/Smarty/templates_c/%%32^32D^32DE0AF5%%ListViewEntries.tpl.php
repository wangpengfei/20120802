<?php /* Smarty version 2.6.18, created on 2012-06-04 08:37:30
         compiled from ListViewEntries.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'getTranslatedString', 'ListViewEntries.tpl', 77, false),array('modifier', 'vtlib_isModuleActive', 'ListViewEntries.tpl', 84, false),array('modifier', 'vtiger_imageurl', 'ListViewEntries.tpl', 93, false),array('function', 'html_options', 'ListViewEntries.tpl', 385, false),)), $this); ?>
...
">
				...
				<tr><td>
				<div class="tabber" id="cv">
				<?php echo $_SESSION['tabnavlist']; ?>
...
" />
				...
				<?php endif; ?>
                				...
                				<?php if ($this->_tpl_vars['BUTTONS'] != '' && vtlib_isModuleActive('PDFMaker') != ''): ?>
                 <input class="crmbutton small edit" type="button" value="<?php echo $this->_tpl_vars['APP']['CREATE_PDF']; ?>
" onclick="return show_tmps(this,'<?php echo $this->_tpl_vars['MODULE']; ?>
')"/>
                 <?php endif; ?>
...
">
			<div style="border: 3px solid rgb(153, 153, 153); background-color: rgb(255, 255, 255); width: 45%; position: relative; z-index: 10000000;">
				...
				<?php if ($this->_tpl_vars['CHECK']['Save'] == 'yes' && $this->_tpl_vars['MODULE'] != 'Emails' && $this->_tpl_vars['MODULE'] != 'Webmails'): ?>
...
:<br>
					<?php if ($this->_tpl_vars['MODULE'] != 'Calendar'): ?>	
		  			&nbsp;&nbsp;-<a href="index.php?module=<?php echo $this->_tpl_vars['MODULE']; ?>
&action=CreateView&return_action=DetailView&parenttab=<?php echo $this->_tpl_vars['CATEGORY']; ?>
...
<?php endif; ?>
					...
					<?php else: ?>
					&nbsp;&nbsp;-<a href="index.php?module=<?php echo $this->_tpl_vars['MODULE']; ?>
&amp;action=CreateView&amp;return_module=Calendar&amp;activity_mode=Events&amp;return_action=DetailView&amp;parenttab=<?php echo $this->_tpl_vars['CATEGORY']; ?>
"><?php echo $this->_tpl_vars['APP']['LBL_CREATE']; ?>
 <?php echo $this->_tpl_vars['APP']['LBL_AN']; ?>
 <?php echo $this->_tpl_vars['APP']['Event']; ?>
</a><br>
					&nbsp;&nbsp;-<a href="index.php?module=<?php echo $this->_tpl_vars['MODULE']; ?>
&amp;action=CreateView&amp;return_module=Calendar&amp;activity_mode=Task&amp;return_action=DetailView&amp;parenttab=<?php echo $this->_tpl_vars['CATEGORY']; ?>
"><?php echo $this->_tpl_vars['APP']['LBL_CREATE']; ?>
...
<input class="crmbutton small edit" type="button" value="<?php echo $this->_tpl_vars['APP']['SHOW_ALL']; ?>
" onclick="showall('<?php echo $this->_tpl_vars['MODULE']; ?>
')"/>
<?php endif; ?>
                                 <?php echo $this->_tpl_vars['LIST_MAX_ENTRIES_PER_PAGE']; ?>
