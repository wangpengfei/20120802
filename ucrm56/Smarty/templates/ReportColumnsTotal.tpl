...
<table class="small" bgcolor="#ffffff" border="0" cellpadding="5" cellspacing="0" height="532" width="100%" valign="top">
	...
	<table style="background-color: rgb(204, 204, 204);" class="small" border="0" cellpadding="5" cellspacing="1" width="100%" valign="top">
		...
		<td ><b>{$MOD.LBL_SELECT_ALL}</b></td>
		<td ><input type="checkbox" name="sun" value ="" onclick="checkEvent1('SUM:2','sun')"></td>
		<td ><input type="checkbox" name="avg" value ="" onclick="checkEvent1('AVG:3','avg')"></td>
		<td ><input type="checkbox" name="min" value ="" onclick="checkEvent1('MIN:4','min')"></td>
		<td ><input type="checkbox" name="max" value ="" onclick="checkEvent1('MAX:5','max')"></td>
		</tr>
...
<tr class="lvtColData" onmouseover="this.className='lvtColDataHover'" onmouseout="this.className='lvtColData'" bgcolor="white">
		<td ><b>{$MOD.LBL_SELECT_ALL}</b></td>
		<td ><input type="checkbox" name="sun" value ="" onclick="checkEvent2('SUM:2','sun')"></td>
		<td ><input type="checkbox" name="avg" value ="" onclick="checkEvent2('AVG:3','avg')"></td>
		<td ><input type="checkbox" name="min" value ="" onclick="checkEvent2('MIN:4','min')"></td>
		<td ><input type="checkbox" name="max" value ="" onclick="checkEvent2('MAX:5','max')"></td>
		</tr>
	{if $ROWS_COUNT eq 0}
