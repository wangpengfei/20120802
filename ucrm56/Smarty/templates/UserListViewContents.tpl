...
<input class="crmbutton small edit" onclick="SMSNotifierCommon.displaySelectWizard(this, 'Users');" type="button" value="{$CMOD.LBL_SEND_SMS_BUTTON_LABEL}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$recordListRange}
	</td>
	<!-- Page Navigation -->
...
<tr>
	<td class="listTableRow small" valign=top>
     <input name="selected_id" id="{$userid}" onclick="check_object(this)" type="checkbox" value="{$userid}"/>
    </td>
