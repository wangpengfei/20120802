...
<table border="0" cellpadding="5" cellspacing="0" width="100%" class="small">
	<tr>
		<td class='dvtCellLabel' align="right" width=15% nowrap="nowrap"><b><font color=red>*</font> {'To'|getTranslatedString:'Emails'}</b></td>
	...
	<tr>
		<td class='dvtCellLabel' align="right" width=15% nowrap="nowrap"><b><font color=red>*</font> {'LBL_LIST_SUBJECT'|getTranslatedString:'Emails'}</b></td>
	...
	<tr>
		...
		<td style='padding-top: 10px;'>
			<select class="small" id="task_timefields">
					<option >{$MOD.Select_Date_Time}</option>
					<option value="{$DATE}">{$MOD.Current_Date}</option>
					<option value="{$TIME}">{$MOD.Current_Time}</option>
			</select>	
		</td>
