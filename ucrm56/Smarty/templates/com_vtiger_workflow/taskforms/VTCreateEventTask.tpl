...
<div id="view">
	...
	<tr valign="top">
		<td class='dvtCellLabel' align="right" width=15% nowrap="nowrap"><b><font color=red>*</font> {$MOD.EVENT_NAME}</b></td>
		<td class='dvtCellInfo'><input type="text" name="eventName" value="{$task->eventName}" id="workflow_eventname" class="form_input"></td>
	</tr>
	<tr valign="top">
		<td class='dvtCellLabel' align="right" width=15% nowrap="nowrap"><b>{$MOD.DESCRIPTION}</b></td>
		<td class='dvtCellInfo'><textarea name="description" rows="8" cols="40" class='detailedViewTextBox'>{$task->description}</textarea></td>
	</tr>
	<tr valign="top">
		<td class='dvtCellLabel' align="right" width=15% nowrap="nowrap"><b>{$MOD.STATUS}</b></td>
	...
	<tr valign="top">
		<td class='dvtCellLabel' align="right" width=15% nowrap="nowrap"><b>{$MOD.TYPE}</b></td>
		<td class='dvtCellInfo'>
	...
	<tr>
		...
		<td>
			<input type="text" name="startDays" value="{$task->startDays}" id="start_days" style="width:30px" class="small"> {$MOD.DAYS} 
	...
	<tr>
		...
		<td><input type="text" name="endDays" value="{$task->endDays}" id="end_days" style="width:30px" class="small"> {$MOD.DAYS} 
