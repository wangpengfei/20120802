 					...
 					<td width="50%" valign=top>
						<form  name="Export_Records"  method="POST" onsubmit="VtigerJS_DialogBox.block();">
							...
							<table align="center" cellpadding="15" cellspacing="0" width="85%" class="mailClient importLeadUI small" border="0">
								...
								<tr>
  									<td border="0" cellpadding="5" cellspacing="0" width="50%">
	 									<table>
											...
											<tr>
												<td colspan="2" align="left" valign="top" style="padding-left:40px;">
													<span class="genHeaderSmall">{$APP.LBL_CHARSET_FORMAT}:</span>
												</td>
			   								</tr>
											<tr>
												<td align="right" valign="top" width="50%" class=small>
								...
								<tr>
								<td colspan="2" class="mailClientBg  genHeaderSmall" valign="middle" align="left">{$APP.LBL_NOTE_EXPORT} </td>
								</tr>
								<tr >
								<td colspan="2"  >
								 {foreach key=key item=item from=$FIELDS}
								 {if  $item neq 'user_name'}
								 <div style="width:200px;float:left"><div style="width:100px;float:left">{$item}</div>
                                 <div style="width:100px;float:left">
                                 <input type="checkbox" name="show[{$item}]" />
                                 <input type="text" name="order_{$item}" style="width:30px;height:10px;"  maxlength="2" onkeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"/>
                                 </div></div>
								  {/if}
								 {/foreach}
