	...
	<div align=center>
			...
			{include file="SetMenu.tpl"}
				...
				<tr>
					...
					<td class=heading2 valign=bottom><b><a href="index.php?module=Settings&action=index&parenttab=Settings">{$MOD.LBL_SETTINGS}</a> > {$MOD.LBL_SMS_SERVER_SETTINGS} </b></td>
				</tr>
				<tr>
				...
				******
				{/if}&nbsp;
						  ...
						  <tr>
							<td nowrap class="small cellLabel"><strong>{$MOD.LBL_FROM_SMS_FIELD}</strong></td>
							<td class="small cellText">{$FROM_SMS_FIELD}&nbsp;</td>
							</td>
						  </tr>
                          <tr>
			...
			<td class="small" valign=top ><table width="100%"  border="0" cellspacing="0" cellpadding="5">
				...
				<input type="password" class="detailedViewTextBox small" value="{$PASSWORD}" name="server_password">
						...
						<tr>
							<td nowrap class="small cellLabel"><strong>{$MOD.LBL_FROM_SMS_FIELD}</strong></td>
							<td class="small cellText">
				 <input type="text" class="detailedViewTextBox small" value="{$FROM_SMS_FIELD}" name="from_email_field"/>
							</td>
						</tr>
						<tr>
                            <td nowrap class="small cellLabel"><strong>{$MOD.LBL_REQUIRES_AUTHENT}</strong></td>
