...
<tr><td colspan="2" class="dvInnerHeader"><b>{$MOD.LBL_SELECT_SMS_TEMPLATE_FOR}  {$NOTIFY_DETAILS.name}</b></td></tr>
<tr>
...
<tr><td colspan="2" class="dvInnerHeader"><b>{$MOD.LBL_SMS_CONTENTS}</b></td></tr>
<tr>
