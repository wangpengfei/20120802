			...
			<table class="small" align="center" border="0" cellpadding="5" cellspacing="0" width="90%">
			  <tbody><tr>
				...
				<tr id="gva">
			          ...
			          <td colspan="4" class="small colHeader"><div align="center"><strong>{$CMOD.LBL_EDIT_PERMISSIONS}</strong></div></td>
			        ...
			        <tr id="gva">
			          ...
			          <td class="small colHeader"><div align="center"><strong> {$CMOD.LBL_EDIT} </strong></div></td>
...
function unSelectCreate(id)
{
	...
	if($('tab_chk_0_'+id).checked == false)
	{
		//unselect_edit_all();
	}else
	{
