...
var groups="{'LBL_GROUPS'|getTranslatedString:'Settings'}";
var roles="{'LBL_ROLES'|getTranslatedString:'Settings'}";
var users="{'LBL_USERS'|getTranslatedString:'Settings'}";
var grp="{'LBL_ROLES_SUBORDINATES'|getTranslatedString:'Settings'}";
