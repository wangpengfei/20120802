...
<tbody>
   ...
   <tr>
	...
	<td class="cellText" style="padding: 5px;" align="left" nowrap>
		...
		</span><span class="mailClientCSSButton" ><img src="{'clear_field.gif'|@vtiger_imageurl:$THEME}" alt="{$APP.LBL_CLEAR}" title="{$APP.LBL_CLEAR}" LANGUAGE=javascript onClick="$('parent_id').value='';$('saved_toid').value=''; $('hidden_toid').value='';$('parent_name').value=''; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>
		</span>
	</td>
   </tr>
	<tr>
   ...
   <tr>
    ...
    {* ITS4YOU-CR PDFMaker *}
    {elseif $COMMON_TEMPLATE_NAME neq ''}
        <tr>
...
var no_email_title_msg = '{$MOD.No_Email_Title_Msg}';
var no_email_title = '{$MOD.No_Email_Title}';
