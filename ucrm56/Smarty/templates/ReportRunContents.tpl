...
<table style="border: 1px solid rgb(0, 0, 0);" align="center" cellpadding="0" cellspacing="0" width="100%">
	...
	<table cellpadding="0" cellspacing="0" width="100%">
        ...
        <br /><img src="jpgraph/graph/line_chart.php?{$graph_param}" /><br /><br /><br /></td></tr>
		<tr><td colspan="2">
		<span class="genHeaderGray">2、饼图：</span>
        <br /><img src="jpgraph/graph/pie_chart.php?{$graph_param}" /><br /><br /><br /></td></tr>
		<tr><td colspan="2">
		<span class="genHeaderGray">3、柱图：</span>
		<br /><img src="jpgraph/graph/bar_chart.php?{$graph_param}" /><br /><br /><br /></td></tr>
		<tr><td colspan="2">
		</td></tr>
		<tr><td colspan="2">&nbsp;</td></tr>
		</tbody>
