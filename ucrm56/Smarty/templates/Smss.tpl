...
//	getObj('search_text').value = '';
	...
	new Ajax.Request(
                ...
                onComplete: function(response) {ldelim}
                                        ...
                                        {ldelim}
                                                gselectedrowid = 0;
                                                $("sms_con").innerHTML=response.responseText;
						...
						<table width="100%"  border="0" cellspacing="0" cellpadding="0">
							...
							&nbsp;<a href="index.php?module=Users&action=AddMailAccount&record={$USERID}" >{$MOD.LBL_SETTINGS}</a>
										...
										<td align=right>
											<table >
											<tr>
												<td class="componentName" align=right>{$MOD.LBL_VTIGER_SMS_CLIENT}<!-- <img src="{'titleMailClient.gif'|@vtiger_imageurl:$THEME}" align="right"/> --></td>
											</tr>
											</table>
									</td>
									</tr>
							...
							<!-- Columns -->
							<tr>
							<td width="18%" class="big mailSubHeader" ><b>{$MOD.LBL_SMS_FOLDERS}</b></td>
							<td>&nbsp;</td>
								...
								<td class="hdrNameBg">
									...
									<input name="idlist" type="hidden">
										<tr>
											...
											<td width="10%">
					<input name="find" value=" {$APP.LBL_FIND} " class="crmbutton small create" onclick="Searchfn();" type="button">
				</td>
										</tr>
									</table>
