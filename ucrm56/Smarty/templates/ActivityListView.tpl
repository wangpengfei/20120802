	...
	<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr>
			<td align="left" valign="top">
				...
				<tr><td><table border=0 cellspacing=1 cellpadding=0 width=100% class="lvtBg" >
				<tr><td>
				   ...
				   {if $HIDE_CUSTOM_LINKS neq '1'}
					...
					<tr>
						...
						<td style="padding-left:5px;padding-right:5px">
						    ...
						    {else}
							<td>
							{if $MODULE eq 'News' and  $IS_ADMIN neq 'ON'}
							{else}
				...
				<tr><td style="background-color:#efefef;height:340px" align="center" colspan="{$smarty.foreach.listviewforeach.iteration+1}">
						<div style="border: 3px solid rgb(153, 153, 153); background-color: rgb(255, 255, 255); width: 45%; position: relative; z-index: 10000000;">
							...
							<td class="small" align="left" nowrap="nowrap">{$APP.LBL_YOU_CAN_CREATE} {$APP.$vowel_conf} {$APP.$MODULE_CREATE} {$APP.LBL_NOW}. {$APP.LBL_CLICK_THE_LINK}:<br>
									...
									&nbsp;&nbsp;-<a href="index.php?module={$MODULE}&amp;action=CreateView&amp;return_module=Calendar&amp;activity_mode=Task&amp;return_action=DetailView&amp;parenttab={$CATEGORY}">{$APP.LBL_CREATE} {$APP.LBL_A} {$APP.Todo}</a>
								</td>
							</tr>
							</table> 
							{else}
