		  ...
		  <div id="customdiv">
				...
				<table width="100%" cellpadding="5" cellspacing="0" class="listTable" >
                    		...
                    		<td width="7%" class="colHeader small" nowrap>{$CMOD.LBL_RULE_NO}</td>
                          	<td width="20%" class="colHeader small" nowrap>{$mod_display} {$CMOD.LBL_BELONG_TO}</td>
...
{ldelim}
		...
		soucre.innerHTML = module +" {$MOD.LBL_BELONG_TO} <b>\"" + select1 + "\"</b> {$CMOD.LBL_CAN_BE_ACCESSED} <b>\"" +select2 + "\"</b> {$CMOD.LBL_IN_PERMISSION} "+select3;
