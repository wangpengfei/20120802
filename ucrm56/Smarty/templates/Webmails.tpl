					...
					<td colspan=2> 
						...
						<td width="1%">&nbsp;</td>
						 ...
						 <table border=0 width="100%" cellspacing=0 cellspacing=0 class="MatrixLayer1">
					 	 <tr>
			<td width="79%" class="big mailSubHeader"><div id="nav"><span style="float:left">{$ACCOUNT} &gt; {$MAILBOX|my_translate}
                             {if $NUM_EMAILS neq 0}
						 {if $NUM_EMAILS neq 1}
						 ...
						 <tr>	
							...
							<table width="100%"  border="0" cellspacing="0" cellpadding="0">
								...
								{if $DEGRADED_SERVICE eq 'false'}
									...
									<font color=red>{$MOD.JUST_IMAP2}</font><font color="#000000">{$APP.LBL_SEARCH}</font>&nbsp;
