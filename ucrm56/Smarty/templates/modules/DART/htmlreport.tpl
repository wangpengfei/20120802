	...
	<tr>
		...
		<td style="background: #FFFFFF; border: 1px solid #DDDDFF; padding: 1px;">
			<table width="100%" cellpadding=0 cellspacing=0 border=0 style="font: inherit; background: #DDDDFF;">
				<tr valign=top>
					<td width="120px" nowrap="nowrap" style="background: #FFFFFF;"><strong>{'LBL_MODULES'|@getTranslatedString:$MODULE}</strong></td>
					<td style="background: #FFFFFF;"><strong>{'LBL_ACTION_PERFORMED'|@getTranslatedString:$MODULE}</strong></td>
				</tr>	
		       </table>
		</td>		
	</tr>
