...
<script type='text/javascript' src="modules/RecycleBin/language/{php} echo $_SESSION['authenticated_user_language'];{/php}.lang.js"></script>
	...
	<tbody>
		<tr>
			<td nowrap="" align="center" style="color: rgb(255, 255, 255); font-size: 15px;">
				<b>{$MOD.MSG_DELETE_RB_CONFIRMATION}</b>
			</td>
		</tr>
		<tr>
			<td align="center">
				<input type="button" onclick="return deleteRecyclebin('rb_delete_conf_id');" value="{$APP.LBL_YES}"/>  
				<input type="button" onclick="$('rb_delete_conf_id').style.display='none';" value="{$APP.LBL_NO}"/>
			</td>
		</tr>
	</tbody>
	</table>
