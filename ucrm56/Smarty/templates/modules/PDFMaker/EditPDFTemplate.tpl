...
<form action="index.php?module=PDFMaker&action=SavePDFTemplate" method="post" enctype="multipart/form-data" onsubmit="VtigerJS_DialogBox.block();">
...
<tr>        
        <td class="showPanelBg" style="padding: 10px;" valign="top" width="100%">
				...
				<tr>
                    {if $EMODE eq 'edit'}
					    {if $DUPLICATE_FILENAME eq ""}
                            <td class=heading2 valign=bottom><b><a href="index.php?module=PDFMaker&action=ListPDFTemplates&parenttab=Tools">{$MOD.LBL_TEMPLATE_GENERATOR}</a> &gt; {$MOD.LBL_EDIT} &quot;{$FILENAME}&quot; </b></td>
                        {else}
                            <td class=heading2 valign=bottom><b><a href="index.php?module=PDFMaker&action=ListPDFTemplates&parenttab=Tools">{$MOD.LBL_TEMPLATE_GENERATOR}</a> &gt; {$MOD.LBL_DUPLICATE} &quot;{$DUPLICATE_FILENAME}&quot; </b></td>
                        {/if}
    				{else}
    					<td class=heading2 valign=bottom><b><a href="index.php?module=PDFMaker&action=ListPDFTemplates&parenttab=Tools">{$MOD.LBL_TEMPLATE_GENERATOR}</a> > {$MOD.LBL_NEW_TEMPLATE} </b></td>
    				{/if}
				...
				<td> 
                    ...
                    {literal}   
                        <script type="text/javascript">
                        	CKEDITOR.replace( 'header_body',{customConfig:'../../../modules/PDFMaker/fck_config_fh.js'} );
                        </script>
                    {/literal}
                    ...
                    {literal}   
                        <script type="text/javascript">
                        	CKEDITOR.replace( 'footer_body',{customConfig:'../../../modules/PDFMaker/fck_config_fh.js'} );		
                        </script>
                    {/literal}
...
{ldelim}
    ...
    if (tabname == "body" && (module == "Quotes" || module == "SalesOrder" || module == "Invoice" || module == "PurchaseOrder" || module == "Issuecards" || module == "Receiptcards"))
    {ldelim}
        document.getElementById('no_product_div').style.display='none';
