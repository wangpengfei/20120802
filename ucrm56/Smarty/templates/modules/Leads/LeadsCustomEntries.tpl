 ...
 ********************************************************************************/ *}
				...
				<table  class="listTableTopButtons" border="0" cellpadding="5" cellspacing="0" width="100%">
					<tr>
						...
						<td align="right"><input type="button" class="crmButton create small" onclick="CustomFieldMapping();" alt="{'LNK_EDIT'|getTranslatedString}" title="{'LNK_EDIT'|getTranslatedString}" value="{'LNK_EDIT'|getTranslatedString}"/>
						</td>
