...
<input name="relmodule" style="margin: 0px;" type="hidden" value="{$MODULE}"/>
...
<TBODY>
<TR>
<TD class=genHeaderSmall width="90%" align=left>{$APP.SELECT_PDF_TEMPLATE}</TD>
...
<TR>
<TD >
<input type="checkbox" name="if_merge"  />{$APP.IF_MERGE_MSG}
<br /><br />
{$APP.SELECT_PDF_TEMPLATE}<br /><br />
...
<INPUT class="small crmbutton create" value={$APP.CREATE_PDF} type=submit> 
<INPUT class="small crmbutton cancel" onclick=fninvsh('pdf_tmp_show'); value={$APP.LBL_BLOCK_CANCEL} type=button>
</TD></TR></TBODY></TABLE>
</DIV>
</div>
</form>
...
var tabberOptions ={ldelim}
 'onClick': function(argsObj) {ldelim}
    var t = argsObj.tabber; /* Tabber object */
    var i = argsObj.index; /* Which tab was clicked (0 is the first tab) */
     showDefaultCustomViewTab(t.tabs[i].div.id,'{$MODULE}','{$CATEGORY}');
