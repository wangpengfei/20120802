...
<tr>
	<td class="genHeaderSmall" align="left" style="border-bottom:1px solid #CCCCCC;" width="60%">{$APP.LBL_APPROVAL}</td>
	<td align="right" style="border-bottom:1px solid #CCCCCC;" width="40%"><a href="javascript:fninvsh('changestatus')">{$APP.LBL_CLOSE}</a></td>
</tr>
<tr>
	<td ><b>{$APP.LBL_APPROVAL} :</b></td>
	<td >
...
<tr>
	...
	&nbsp;&nbsp;
	<input type="button" name="button" class="crmbutton small edit" value="{$APP.LBL_APPROVAL}" onClick="ChangeStatus('changestatus')">
	<input type="button" name="button" class="crmbutton small cancel" value="{$APP.LBL_CANCEL_BUTTON_LABEL}" onClick="fninvsh('changestatus')">
</td>
</tr>
</table>
</div>
