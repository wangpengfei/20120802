...
if($_REQUEST["domkeyid"]=="ModApprovalsDetailViewBlockApprovalWidget"){
	$url_string .='&domkeyid=ModApprovalsDetailViewBlockApprovalWidget';
	$url		.='&domkeyid=ModApprovalsDetailViewBlockApprovalWidget';
}
...
if(isset($_REQUEST['query']) && $_REQUEST['query'] == 'true')
{
	...
	if($currentModule == 'Users' && $_REQUEST['search_field'] == 'roleid'){
		$where = "vtiger_role.rolename like '%".$_REQUEST['search_text']."%' ";
	}elseif($currentModule == 'Users' && $_REQUEST['search_field'] == 'status'){
