					   ...
					   <tr bgcolor="#FFFFFF">
						...
						<td valign="top">
							   ...
							   <tr>
								<?php
								   ...
								   if($_REQUEST['login_error'] != '')
									echo base64_decode( str_replace(' ','+',$_REQUEST['login_error'])); 
								?>
							   </tr>
							   <tr>
						   <td colspan="2" class="detailedViewHeader"><b><?php echo getTranslatedString('customerportal');echo " ".$version; ?></b></td>
							   ...
							   <tr>
								<td  colspan="2" align="right"> <a href="sign_up.php" > <?php echo getTranslatedString('LBL_SIGN_UP');?></a> &nbsp;&nbsp;|&nbsp;&nbsp;<a href='javascript:;' onclick='window.open("supportpage.php?param=forgot_password","ForgotPassword","width=400,height=250");'><?php  echo getTranslatedString('LBL_FORGOT_LOGIN');?></a></td>
							   </tr>
