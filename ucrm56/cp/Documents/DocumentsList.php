...
echo '<tr>
	 			<td><span class="lvtHeaderText">'.getTranslatedString("LBL_NOTES_INFORMATION").'</span>
<input class="crmbutton small cancel" onclick="window.location.href=\'index.php?module=Documents&action=EditView\'" type="button" value="'.getTranslatedString("LBL_NEW_RECORED").'" />
				</td>';    
