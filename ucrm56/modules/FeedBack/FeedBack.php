...
class FeedBack extends CRMEntity {
	var $db, $log; // Used in class functions of CRMEntity

	var $table_name = 'vtiger_feedback';
	var $table_index= 'feedbackid';
	 ...
	 */
	var $customFieldTable = Array('vtiger_feedbackcf', 'feedbackid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_feedback', 'vtiger_feedbackcf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_feedback' => 'feedbackid',
		'vtiger_feedbackcf'=>'feedbackid');
	...
	var $list_fields = Array (
		...
		'FeedBackName' => Array('feedback', 'feedbackname'),
	...
	var $list_link_field = 'feedbackname';
	...
	var $popup_fields = Array ('feedbackname');

	// Allow sorting on the following (field column names)
	var $sortby_fields = Array ('feedbackname');

	// Should contain field labels
	//var $detailview_links = Array ('FeedBackName');

	// For Alphabetical search
	var $def_basicsearch_col = 'feedbackname';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'feedbackname';
	...
	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'feedbackname');
