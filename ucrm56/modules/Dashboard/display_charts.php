...
$graph_array = Array(
	  ...
	  "accountstatistics"=> $mod_strings['accountstatistics'],
	  "leadsstatistics"=> $mod_strings['leadsstatistics'],
  );
	if(isset($_REQUEST['from_page']) && $_REQUEST['from_page'] == 'HomePage')
	{
		...
		//Charts for Lead Source
			...
			//accountstatistics
		    elseif ($profileTabsPermission[getTabid("Accounts")] == 0 && ($type == "accountstatistics") && $profileTabsPermission[getTabid("Accounts")] == 0)
		    {
			    $graph_by="smownerid";
			    $graph_title=$mod_strings['accountstatistics'];
			    $module="Accounts";
			    $where="";
			    $query=getDashboardQuery($account_query,$module);
			...
			elseif ($profileTabsPermission[getTabid("Leads")] == 0 && ($type == "leadsstatistics") && $profileTabsPermission[getTabid("Leads")] == 0)
		    {
			    $graph_by="smownerid";
			    $graph_title=$mod_strings['leadsstatistics'];
			    $module="Leads";
			    $where="";
			    $query=getDashboardQuery($leads_query,$module);
	...
	else
	{
		...
		//Charts for Lead Source
			...
			elseif ($profileTabsPermission[getTabid("Accounts")] == 0 && ($type == "accountstatistics") && $profileTabsPermission[getTabid("Accounts")] == 0)
		    {
			    ...
			    return get_graph_by_type($graph_by,$graph_title,$module,$where,$query);
		    }
		    elseif ($profileTabsPermission[getTabid("Leads")] == 0 && ($type == "leadsstatistics") && $profileTabsPermission[getTabid("Leads")] == 0)
		    {
			    $graph_by="smownerid";
