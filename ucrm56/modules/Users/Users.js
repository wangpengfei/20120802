...
function set_return_withdomid(domkeyid,user_id, user_name) {
	var reportsToName = window.opener.document.getElementById('reports_to_name_'+domkeyid);
	var reportsToID = window.opener.document.getElementById('reports_to_id_'+domkeyid);

		reportsToName.value = user_name;
		reportsToID.value = user_id;
}
var fckEditoFrame = '';
