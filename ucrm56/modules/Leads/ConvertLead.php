...
global $mod_strings,$app_strings,$log,$current_user,$theme,$current_language;
...
$convertlead = '<form name="ConvertLead" method="POST" action="index.php" onsubmit="return verify_data1(this);VtigerJS_DialogBox.block();">
...
if(vtlib_isModuleActive('Potentials') && (isPermitted('Potentials','CreateView')== 'yes')){			
