...
{
	$mailbox=str_replace('&amp;','&',vtlib_purify($_REQUEST["mailbox"]));
}
else
{
	$mailbox="INBOX";
...
$strpos = strpos($email->to_header,'Received: by');
$to = decode_header(substr($email->to_header,0,$strpos?$strpos:strlen($email->to_header)));
...
<!-- Table to display the Header details (From, To, Subject and date) - Starts -->
                                        ...
                                        <table <?php echo $class_str;?> width="100%" border="0" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr><td  width="100%" align="left">&nbsp;<b><?php echo $mod_strings['LBL_TO'];?></b><?php echo iconv('GBK','UTF-8',$to);?></td></tr>
<tr><td width="100%" align="left">&nbsp;<b><?php echo $mod_strings['LBL_CC'];?></b><?php echo $cc;?></td></tr>
	...
	<tr>
		<td align="left">&nbsp;<b><?php echo $mod_strings['LBL_ATTACHMENT'];?>:</b><?php echo iconv('GBK','UTF-8',$attachment_links);?></td>
	</tr>
	<?php } ?>
