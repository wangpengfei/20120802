...
function editworkflowscript($, conditions){
 ...
 function gettranslate(condition)
{
 	  switch( condition )
			{
				case "equal to":
					return alert_arr.EQUALS;
				case "less than":
					return alert_arr.LESS_THAN;
				case "greater than":
					return alert_arr.GREATER_THAN;
				case "does not equal":
					return alert_arr.NOT_EQUALS_TO;
				case "less than or equal to":
					return alert_arr.LESS_OR_EQUALS;
				case "greater than or equal to":
					return alert_arr.GREATER_OR_EQUALS;
				case "is":
					return alert_arr.YES;
				case "contains":
					return alert_arr.CONTAINS;
				case "does not contain":
					return alert_arr.DOES_NOT_CONTAINS;
				case "starts with":
					return alert_arr.STARTS_WITH;
				case "ends with":
					return "结尾是";
				case "matches":
					return "匹配";
	...
	function resetFields(opType, condno){
		...
		ops.empty();
		$.each(l, function(k, v){
			var v_tmp = gettranslate(v);
			if(v_tmp)v=v_tmp;
			ops.append('<option value="'+k+'">'+v+'</option>');
		});
		//fillOptions(ops, l);
