	...
	class SalesOrderPDFHeaderViewer extends Vtiger_PDF_InventoryHeaderViewer {
		...
		function display($parent) {
			...
			if($current_language=="zh_cn")
			{
				...
				{
					$modelColumnLeft['logo'] = mb_convert_encoding($modelColumnLeft['logo'],'GB2312',$default_charset);
				}
				else 
				{
					$modelColumnLeft['logo'] = iconv($default_charset,'GB2312',$modelColumnLeft['logo']);
				}
			}
