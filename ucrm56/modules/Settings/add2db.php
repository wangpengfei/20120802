...
require_once('include/utils/utils.php');
	...
	{	
  		...
  		if($current_language=="zh_cn")
		{
			...
			{
				$mbinFile = mb_convert_encoding($_FILES["binFile"]["name"],'GB2312',$default_charset);
			} 
			else 
			{		
				$mbinFile = iconv($default_charset,'GB2312',$_FILES["binFile"]["name"]);	
			}
		}
		move_uploaded_file($_FILES["binFile"]["tmp_name"],$uploaddir.$mbinFile); 
	}	
