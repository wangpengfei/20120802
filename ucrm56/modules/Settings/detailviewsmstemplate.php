...
$log->info("Inside Sms Template Detail View");
...
if(isset($_REQUEST['templateid']) && $_REQUEST['templateid']!='')
{
	...
	$smstemplateResult = $adb->fetch_array($result);
}

$smarty->assign("TEMPLATEID", $smstemplateResult["templateid"]);
$smarty->assign("SUBJECT", $smstemplateResult["subject"]);
$smarty->assign("BODY", decode_html($smstemplateResult["body"]));
$smarty->display("DetailViewSmsTemplate.tpl");
?>
