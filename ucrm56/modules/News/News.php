...
class News extends CRMEntity {
	var $db, $log; // Used in class functions of CRMEntity

	var $table_name = 'vtiger_news';
	var $table_index= 'newsid';
	 ...
	 */
	var $customFieldTable = Array('vtiger_newscf', 'newsid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_news', 'vtiger_newscf');
	...
	var $popup_fields = Array('newsname');

	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
	var $sortby_fields = Array();

	// For Alphabetical search
	var $def_basicsearch_col = 'newsname';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'newsname';

	// Required Information for enabling Import feature
	var $required_fields = Array('newsname'=>1);
	...
	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'newsname');
