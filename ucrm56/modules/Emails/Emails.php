...
function pdfAttach($obj,$module,$file_name,$id)
{
	...
	if($current_language=="zh_cn")
	{
		...
		{
			$source_file_path1 = mb_convert_encoding($source_file_path,'GB2312',$default_charset);
			$file_name1 = mb_convert_encoding($file_name,'GB2312',$default_charset);
		}
		else 
		{
			$source_file_path1 = iconv($default_charset,'GB2312',$source_file_path);
			$file_name1 = iconv($default_charset,'GB2312',$file_name);
		}
	}

	$status = copy($source_file_path1, $upload_file_path.$current_id."_".$file_name1);
