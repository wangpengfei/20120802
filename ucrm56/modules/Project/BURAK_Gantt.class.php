...
// 		$x1 = $x + (($this->inc_x - $w)/2);
	...
	function drawGroup($id){
		...
		imagettftext($this->im,10,0,($pos["x1"]-3),($pos["y1"]-3),$this->colors["font"],'Image/Canvas/Fonts/simhei.ttf',$d);
	...
	function drawMilestone($id){
		...
		imagettftext($this->im,10,0,($pos["x1"]-3),($pos["y1"]-3),$this->colors["font"],'Image/Canvas/Fonts/simhei.ttf',$this->data_gantt[$id]["label"]);
	}
