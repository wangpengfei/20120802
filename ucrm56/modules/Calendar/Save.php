...
if((isset($_REQUEST['change_status']) && $_REQUEST['change_status']) && ($_REQUEST['status']!='' || $_REQUEST['eventstatus']!=''))
{
	...
	{
		getEventNotification($mod_strings['LBL_'.strtoupper($activity_type)],$mail_data['subject'],$mail_data);
	}
...
if($_REQUEST['sendnotification'] == 'on')
{
	...
	getEventNotification($mod_strings['LBL_'.strtoupper($_REQUEST['activity_mode'])],$_REQUEST['subject'],$mail_contents);
}
